...
//  Author :            Shraddha Dattatraya Salunkhe
//  Date :              31/07/2026
//
//////////////////////////////////////////////////////
...
//  Description :       It is used to open the 
//                      specific file
//  Input :             File Descriptior
//                      address of empty buffer, Size of data
//  Output :            Number of bytes succesfully read
//  Author :            Shraddha Dattatraya Salunkhe
//  Date :              07/08/2026
//
...
//  Description :       It is used take backup of all files 
//                      in the current directory
//  Input :            
//                     
//  Output :            backup files saved
//  Author :            Shraddha Dattatraya Salunkhe
//  Date :              07/08/2026
//
//////////////////////////////////////////////////////
...
void Backup()
{
    ...
    char BackupFileName[30] = {'\0'};

    while(temp != NULL)
    {
        if(temp->FileType != 0)
        {
            sprintf(BackupFileName,"%s.bak",temp->FileName);

            fp = fopen(BackupFileName,"w");

            fwrite(temp->Buffer,1,temp->ActualFileSize,fp);
...
int main()
{
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            // Marvellous CVFS : > open 1
            else if(strcmp(Command[0],"open") == 0)
            {
                open_file(atoi(Command[1]), InputBuffer, size-1);
            }
            // Marvellous CVFS : > backup
